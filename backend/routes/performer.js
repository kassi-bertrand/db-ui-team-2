...
router.post('/', async (req, res, next) => {
    const createPerformer = await Performer.createPerformer(req.body.username, req.body.username, req.body.performer_name, req.body.details, req.body.num_performers, req.body.available);
