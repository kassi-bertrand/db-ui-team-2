                ...
                <div class="flex items-center sm:justify-between sm:gap-4">
                    ...
                    <div class="flex flex-1 items-center justify-between gap-8 sm:justify-end">
                        ...
                        <div className="relative">
                            <button class="flex shrink-0 items-center rounded-lg">
                                {/**Random picture */}
                                <img
                                    alt="Man"
                            ...
                            <div className="absolute right-0 z-10 mt-4 origin-top-right rounded-md border border-gray-100 bg-white shadow-lg">
                                <div className="flex p-2 text-red-600">
                                    ...
                                    <a href="#" className="block rounded-lg px-4 py-2 text-sm hover:bg-gray-50">
                                        Logout
                                    </a>
                                </div>
                            </div>
